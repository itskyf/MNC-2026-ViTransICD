...
- Modern Python 3.13 Typing: Use modern Python typing (`dict[str, int]`, `X | None`); avoid `typing.Any` and hand-crafted attribute names. Utilize `Enum`/`StrEnum`, `TypedDict`, and `dataclasses` where appropriate.
